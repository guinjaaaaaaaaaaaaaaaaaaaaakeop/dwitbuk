...
The latest review is the open set. A finding seen again inherits its disposition; a finding that stops recurring without one is carried as `undisposed`.
